...
- Per term: define it on first use, or cut it? Some are real Japanese vocabulary worth teaching (kana, dakuten, radicals); some are ours and should go (combo).
- Your idea from the copy review: an intro card before each lesson type that lacks one. Worth doing?
