...
export const SRS_INTRO_PARAGRAPHS: readonly string[] = [
  ...
  "The recall part matters more than it looks. When you don't remember something right away and you genuinely try hard to pull it back before giving up, that struggle is what burns it into memory. A hint or an early skip feels efficient in the moment, but it trades that struggle away: a hint spends the credit for answering it cleanly on your own, and a skip just meets the same card again without you ever having wrestled with it. Try your best before you reach for either one.",
...
export const SRS_INTRO_LINK_TEXT =
  "has the full reference: what \"I already know\" does, what the progress words mean, and this in more detail.";
