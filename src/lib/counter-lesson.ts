 ...
 *      割/階/円, then day-of-month and month-of-year last): its rule unit,
 *      followed by any memorised
 ...
 *      "…, sai, wari, floor, en, day, month" — that trailing order is what puts
 *      them last here, with no bespoke step of their own).
