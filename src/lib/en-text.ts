// Plain text work on an English gloss, with no data behind it.
//
// These are the deterministic layers of the English answer matcher, split out
// of en-match.ts so a caller can have them without the curated synonym pool
// (src/data/generated/en-synonyms.json, 3.2 MB) that lives there. The Sky's
// quiz grades in the browser and needs the layers, not the pool: it is handed
...
export function withinTypo(given: string, candidate: string): boolean {
