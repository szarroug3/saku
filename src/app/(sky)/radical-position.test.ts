...
//
// These cases moved here with the function (SAK-398); they used to live in
// lib/library/character-entry-content.test.ts.

import assert from "node:assert/strict";
import test from "node:test";

import { derivePosition } from "./radical-position.ts";
