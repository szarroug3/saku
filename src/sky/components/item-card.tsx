...
// - A locked state, in any form. What cannot be picked yet is not shown at all
//   (Sam's call, 2026-09-04), so a card that cannot be picked never reaches
//   this component. A sentence type used to be the exception: it kept its place
//   in the order as a dim tile reading "Opens once you know は or が". Sam,
//   2026-09-17: "just let it open when it opens." It is out of the row until
//   what it needs is learned or picked tonight, and then it is an ordinary
//   tile (SAK-464).
//
