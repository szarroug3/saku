...
export const BATCH_07: Readonly<Record<string, string>> = {
  ...
  害: "This glyph means harm or injury. It uses the definition of 宀 (house) and 口 (mouth), and the sound piece 丯, drawn here as 龶. The sources give more than one account of it, so the origin is not settled.",
  業: "This glyph means work, a vocation, or a performing art. The parts drawn are 业, 羊 and 木. It pictured a notched board, read as chisel teeth, 丵, over 大, but the accounts differ and it is not settled.",
  ...
  常: "This glyph first meant a long skirt and came to mean usual or constant. It uses the sound of 尚, with cloth, 巾, below it inside the 吊.",
