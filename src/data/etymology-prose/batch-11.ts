...
export const BATCH_11: Readonly<Record<string, string>> = {
  ...
  赤: "A person beside a fire: the color of fire, red. The person, 大, was simplified into the 土 on top, and the fire below is stylized past recognizing.",
  ...
  夏: "This glyph means summer. The parts drawn are 一, 自 and 夂. One reading has a man toiling under the sun, 頁 below 日, but the identification is uncertain and the shape was reworked several times, so it is not settled.",
  ...
  舞: "This glyph means to dance. It uses the definition of 舛 (two feet stepping) and the sound of the strokes above it, which stand for 無, a word that itself first meant dancing.",
