...
export const BATCH_29: Readonly<Record<string, string>> = {
  ...
  睦: "This glyph means friendly and harmonious. It uses the definition of 目 (eyes); the sound piece 坴 is drawn here as 土, 儿 and 土.",
  絹: "This glyph means silk. It uses the definition of 糸 (thread) and the sound of 肙.",
  羨: "Saliva over a sheep (羊): to drool with envy, to covet. The saliva is written 㳄 and drawn here as 氵 with 欠.",
  ...
  奪: "This glyph means to snatch away by force. The parts drawn are 奞 and 寸. The older form showed a hand seizing a bird from someone's clothing, written 又, 隹 and 衣, and the modern shape no longer separates them.",
