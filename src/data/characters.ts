...
const HIRAGANA_ROWS: Row[] = [
  ...
  ["h-kya", "Combo きゃ", ["きゃ", "きゅ", "きょ"], R.ky],
  ["h-sha", "Combo しゃ", ["しゃ", "しゅ", "しょ"], R.sh],
  ["h-cha", "Combo ちゃ", ["ちゃ", "ちゅ", "ちょ"], R.ch],
  ["h-nya", "Combo にゃ", ["にゃ", "にゅ", "にょ"], R.ny],
  ["h-hya", "Combo ひゃ", ["ひゃ", "ひゅ", "ひょ"], R.hy],
  ["h-mya", "Combo みゃ", ["みゃ", "みゅ", "みょ"], R.my],
  ["h-rya", "Combo りゃ", ["りゃ", "りゅ", "りょ"], R.ry],
  ["h-gya", "Combo ぎゃ", ["ぎゃ", "ぎゅ", "ぎょ"], R.gy],
  ["h-ja", "Combo じゃ", ["じゃ", "じゅ", "じょ"], R.j],
  ["h-dja", "Combo ぢゃ", ["ぢゃ", "ぢゅ", "ぢょ"], R.dj],
  ["h-bya", "Combo びゃ", ["びゃ", "びゅ", "びょ"], R.by],
  ["h-pya", "Combo ぴゃ", ["ぴゃ", "ぴゅ", "ぴょ"], R.py],
];
...
const KATAKANA_ROWS: Row[] = [
  ...
  ["k-kya", "Combo キャ", ["キャ", "キュ", "キョ"], R.ky],
  ["k-sha", "Combo シャ", ["シャ", "シュ", "ショ"], R.sh],
  ["k-cha", "Combo チャ", ["チャ", "チュ", "チョ"], R.ch],
  ["k-nya", "Combo ニャ", ["ニャ", "ニュ", "ニョ"], R.ny],
  ["k-hya", "Combo ヒャ", ["ヒャ", "ヒュ", "ヒョ"], R.hy],
  ["k-mya", "Combo ミャ", ["ミャ", "ミュ", "ミョ"], R.my],
  ["k-rya", "Combo リャ", ["リャ", "リュ", "リョ"], R.ry],
  ["k-gya", "Combo ギャ", ["ギャ", "ギュ", "ギョ"], R.gy],
  ["k-ja", "Combo ジャ", ["ジャ", "ジュ", "ジョ"], R.j],
  ["k-dja", "Combo ヂャ", ["ヂャ", "ヂュ", "ヂョ"], R.dj],
  ["k-bya", "Combo ビャ", ["ビャ", "ビュ", "ビョ"], R.by],
  ["k-pya", "Combo ピャ", ["ピャ", "ピュ", "ピョ"], R.py],
];
