    ...
    buildSections: [{
      ...
      tables: [
      {
        ...
        rules: [
          ...
          { label: "", verb: "まつ", drop: "つ", add: "って", gloss: WORD_GLOSS["まつ"] },
          { label: "", verb: "とる", drop: "る", add: "って", gloss: WORD_GLOSS["とる"] },
          { label: "む・ぶ・ぬ", verb: "のむ", drop: "む", add: "んで", gloss: WORD_GLOSS["のむ"] },
          { label: "", verb: "あそぶ", drop: "ぶ", add: "んで", gloss: WORD_GLOSS["あそぶ"] },
          { label: "", verb: "しぬ", drop: "ぬ", add: "んで", gloss: WORD_GLOSS["しぬ"] },
          { label: "く", verb: "かく", drop: "く", add: "いて", gloss: WORD_GLOSS["かく"] },
          { label: "ぐ", verb: "およぐ", drop: "ぐ", add: "いで", gloss: WORD_GLOSS["およぐ"] },
          { label: "す", verb: "はなす", drop: "す", add: "して", gloss: WORD_GLOSS["はなす"] },
        ],
        heads: { label: "Ending" },
      },
      {
        title: "Ichidan (る-verbs)",
        rules: [{ verb: "たべる", drop: "る", add: "て", gloss: WORD_GLOSS["たべる"] }],
      },
      {
