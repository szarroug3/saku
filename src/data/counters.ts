...
const HON: readonly CounterForm[] = [
  counted("counter:hon:1", "一本", "いっぽん", "one long object", "本", "一", 2),
  counted("counter:hon:2", "二本", "にほん", "two long objects", "本", "二", 2),
  counted("counter:hon:3", "三本", "さんぼん", "three long objects", "本", "三", 2),
  counted("counter:hon:4", "四本", "よんほん", "four long objects", "本", "四", 2),
  counted("counter:hon:5", "五本", "ごほん", "five long objects", "本", "五", 2),
  counted("counter:hon:6", "六本", "ろっぽん", "six long objects", "本", "六", 2),
  counted("counter:hon:7", "七本", "ななほん", "seven long objects", "本", "七", 2),
  counted("counter:hon:8", "八本", "はっぽん", "eight long objects", "本", "八", 2),
  counted("counter:hon:9", "九本", "きゅうほん", "nine long objects", "本", "九", 2),
  counted("counter:hon:10", "十本", "じゅっぽん", "ten long objects, also じっぽん", "本", "十", 2),
];
