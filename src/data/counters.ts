...
// いち〜じゅう used to ship here as memorized kana forms (counter:num:1..10). They
...
// ひとり (一人), ふたり (二人) and よにん (四人) used to ship as memorized kana forms.
...
// The teens, tens, hundreds and thousands are NOT shipped as memorized forms,
...
// ─── Phase 3 · the one memorized tail form ─────────────────────────────────
...
// number-quiz.ts) that biases which count a rolled round favors, never as
 ...
 * units. The only memorized form left is the one special tail reading (二十歳
 ...
 * a key irregular. Not a seventh subject; a labeled set within this track. */
 ...
 *
 * It carries BOTH the memorized forms' entries AND the generative categories'
 ...
 * month-of-year last (SAK-163 round 4 — they were a closed, memorized pair of
...
/** The track label — the memorized forms' entries and the categories' entries.
