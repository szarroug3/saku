...
export const MNEMONICS: Record<MnemonicKey, Mnemonic> = {
  ...
  ス: {
    ...
    mnemonic: [
      { text: "A " },
      { text: "su", accent: true },
      { text: "perhero hovers facing right, chest puffed out while his cape streams across the top." },
    ],
  ...
  ユ: {
    ...
    mnemonic: [
      { text: "You", accent: true },
      { text: " shiver in an icy bath and splash a puddle to the right." },
    ],
  ...
  ン: {
    ...
    mnemonic: [
      { text: "A fountain pe" },
      { text: "n", accent: true },
      { text: " makes the short upper mark, then sweeps a long ink line upward." },
    ],
