...
export const MNEMONICS: Record<MnemonicKey, Mnemonic> = {
  ...
  イ: {
    ...
    mnemonic: [
      { text: "An " },
      { text: "ea", accent: true },
      { text: "gle stands tall, one long wing sweeping down to the side while its body holds straight." },
    ],
  ...
  ク: {
    ...
    mnemonic: [
      ...
      { text: "coo", accent: true },
      { text: "k bends to smell his delicious " },
      { text: "coo", accent: true },
      { text: "king." },
    ],
  ...
  ス: {
    ...
    mnemonic: [
      { text: "A " },
      { text: "su", accent: true },
      { text: "perhero hovers facing right, chest puffed out while his cape streams across the sky." },
    ],
    example: { word: "スキー", reading: "sukii", gloss: "ski", hitIndex: 0 },
  },
  ...
  せ: {
    ...
    mnemonic: [
      ...
      { text: "ntipedes " },
      { text: "se", accent: true },
      { text: "ttle onto a branch to enjoy the sunny day." },
    ],
  ...
  ち: {
    ...
    romaji: "chi",
    sound: "chee",
    object: "a smiling face with glasses",
    analogy: [
      { text: "Say “" },
    ...
    mnemonic: [
      { text: "A face in glasses grins an enormous smile and says “" },
      { text: "chee", accent: true },
      { text: "eeeese!”" },
    ],
  ...
  と: {
    ...
    mnemonic: [
      { text: "A splinter jabs a bare " },
      { text: "toe", accent: true },
      { text: ", one sharp spike crossing straight over it." },
    ],
  ...
  ニ: {
    ...
    mnemonic: [
      ...
      { text: "t " },
      { text: "nee", accent: true },
      { text: "dle stitches lie flat and parallel. You tug the thread to check they hold." },
    ],
  ...
  ぬ: {
    ...
    mnemonic: [
      { text: "Twirl the " },
      { text: "noo", accent: true },
      { text: "dles up off the bowl in one big looping slurp." },
    ],
  ...
  ね: {
    ...
    mnemonic: [
      { text: "Ne", accent: true },
      { text: "lly the cat stretching her back up high, ready for her afternoon nap." },
    ],
  ...
  ホ: {
    ...
    mnemonic: [
      { text: "A " },
      { text: "ho", accent: true },
      { text: "ly cross radiates strong beams of sunlight and " },
      { text: "ho", accent: true },
      { text: "pe." },
    ],
  ...
  ヤ: {
    ...
    mnemonic: [
      { text: "A " },
      { text: "ya", accent: true },
      { text: "cht leans into the wind, its sail full and mast tilted." },
    ],
  ...
  ユ: {
    ...
    mnemonic: [
      { text: "You", accent: true },
      { text: " shiver in an icy bath and splash a puddle over the side while your teeth chatter." },
    ],
  ...
  レ: {
    ...
    analogy: [
      ...
      { text: "reh", accent: true },
      { text: "” like the start of " },
      { text: "wre", accent: true },
      { text: "n." },
    ],
    mnemonic: [
      { text: "A " },
      { text: "wre", accent: true },
      { text: "n cranes her neck straight up while her tail feathers sweep gently right." },
    ],
    example: { word: "レモン", reading: "remon", gloss: "lemon", hitIndex: 0 },
    approximate: "A single soft tap of the tongue, not a hard English “r.”",
  },
  ...
  ん: {
    ...
    mnemonic: [
      { text: "A fountain pen loops out a lowercase cursive " },
      { text: "n", accent: true },
  ...
  ン: {
    ...
    romaji: "n",
    sound: "n",
    object: "fountain pen and ink line",
    analogy: [
      { text: "Hold the final " },
      { text: "n", accent: true },
      { text: " in pe" },
